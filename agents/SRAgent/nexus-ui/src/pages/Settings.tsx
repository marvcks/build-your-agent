...
const Settings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'general' | 'model' | 'pysr' | 'api'>('general')
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-md">
                    <div>
                      ...
                      <input
                        ...
                        max="1000"
                        className="input w-full"
                        value={settings.pysr.populations}
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            pysr: { ...settings.pysr, populations: parseInt(e.target.value) },
                          })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        max="10000"
                        className="input w-full"
                        value={settings.pysr.iterations}
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            pysr: { ...settings.pysr, iterations: parseInt(e.target.value) },
                          })
                        }
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 max-w-md">
                    <div>
                      ...
                      <input
                        ...
                        max="100"
                        className="input w-full"
                        value={settings.pysr.maxSize}
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            pysr: { ...settings.pysr, maxSize: parseInt(e.target.value) },
                          })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        max="20"
                        className="input w-full"
                        value={settings.pysr.maxDepth}
                        onChange={(e) =>
                          setSettings({
                            ...settings,
                            pysr: { ...settings.pysr, maxDepth: parseInt(e.target.value) },
                          })
                        }
                      />
                    </div>
                      ...
                      {['+', '-', '*', '/', '**'].map((op) => (
                        <label key={op} className="flex items-center gap-2">
                          <input
                            ...
                            checked={settings.pysr.binaryOperators.includes(op)}
                            onChange={(e) => {
                              if (e.target.checked) {
                                setSettings({
                                  ...settings,
                                  pysr: {
                                    ...settings.pysr,
                                    binaryOperators: [...settings.pysr.binaryOperators, op],
                                  },
                                })
                              } else {
                                setSettings({
                                  ...
                                  pysr: {
                                    ...settings.pysr,
                                    binaryOperators: settings.pysr.binaryOperators.filter(
                                      (o) => o !== op
                                    ),
                                  },
                                })
                        ...
                        (op) => (
                          <label key={op} className="flex items-center gap-2">
                            <input
                              type="checkbox"
                              className="w-4 h-4 rounded border-apple-gray-300 text-apple-blue focus:ring-apple-blue"
                              checked={settings.pysr.unaryOperators.includes(op)}
                              onChange={(e) => {
                                if (e.target.checked) {
                                  setSettings({
                                    ...settings,
                                    pysr: {
                                      ...settings.pysr,
                                      unaryOperators: [...settings.pysr.unaryOperators, op],
                                    },
                                  })
                                } else {
                                  setSettings({
                                    ...
                                    pysr: {
                                      ...settings.pysr,
                                      unaryOperators: settings.pysr.unaryOperators.filter(
                                        (o) => o !== op
                                      ),
                                    },
                                  })
